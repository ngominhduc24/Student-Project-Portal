...
CREATE TABLE IF NOT EXISTS `subject` (
                                         `id` INT NOT NULL AUTO_INCREMENT,
                                         `subject_manager_id` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `class_issue_setting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `class_issue_setting` ;

CREATE TABLE IF NOT EXISTS `class_issue_setting` (
                                                     `id` INT NOT NULL AUTO_INCREMENT,
                                                     `class_id` INT NULL,
                                                     `type` INT NULL,
                                                     `status` BIT(1) NULL,
...
CREATE TABLE IF NOT EXISTS `subject_setting` (
                                                 `id` INT NOT NULL AUTO_INCREMENT,
