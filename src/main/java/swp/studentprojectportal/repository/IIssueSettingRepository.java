...
public interface IIssueSettingRepository extends JpaRepository<IssueSetting, Integer> {
    ...
    @Query(value="SELECT * FROM issue_setting\n" +
            "WHERE subject_id = :subjectId AND setting_group = :group AND setting_title = :title",nativeQuery = true)
    Optional<IssueSetting> findIssueSettingBySubjectAndSettingGroupAndSettingTitle(@Param("subjectId") int subjectId, @Param("group") String settingGroup, @Param("title") String settingTitle);

    @Query(value="SELECT * FROM issue_setting\n" +
            "WHERE project_id = :projectId AND setting_group = :group AND setting_title = :title",nativeQuery = true)
    Optional<IssueSetting> findIssueSettingByProjectAndSettingGroupAndSettingTitle(@Param("projectId") int projectId, @Param("group") String settingGroup, @Param("title") String settingTitle);
